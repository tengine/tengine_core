...
driver :driver52_alt1_1 do
  on:event52_alt1 do
    puts "handler52_alt1_1 " << (ack? ? "acknowledged" : "unacknowledged")
    submit
  end
end
...
driver :driver52_alt1_2 do
  on:event52_alt1 do
    puts "handler52_alt1_2 " << (ack? ? "acknowledged" : "unacknowledged")
...
driver :driver52_alt1_3 do
  on:event52_alt1 do
    puts "handler52_alt1_3 " << (ack? ? "acknowledged" : "unacknowledged")
    submit
  end
end
